...
export default async function NewOrderPage() {
  ...
  return <>
    <PageHeader title="New Order" description="Create an order and snapshot product price, USD cost, FX, and reseller commission." />
    <Card className="max-w-3xl"><form action={createOrder} className="grid gap-4 md:grid-cols-2">
      ...
      <div><label>FX Rate USD/PHP</label><input defaultValue="58" name="fx_rate_usd_php" required step="0.000001" type="number" /></div>
